...
//Adicionar um caractere do final dele
let myStr: string = "banan";
console.log(myStr.concat("a"));

//Remover um caractere do final dele
let myStr2: string = "bananak";
console.log(myStr2.slice(0, -1));

//Substituir um caractere por outro
let myStr3: string = "panana";
console.log(myStr3.replace("p", "b"));
